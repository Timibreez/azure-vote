...
# Now you will see $myAcrName.azurecr.io/azure-vote-front:v1 if you run "docker images"
...
# az aks update -n $myAcrName-cluster -g acdnd-c4-project --attach-acr $myAcrName